...
$result = utf8_decode( sprintf( esc_html__( 'Payment for order #%1$s from %2$s has failed. The order was as follows:', 'marketplace' ), esc_html( $order->get_order_number() ), esc_html( $order->get_formatted_billing_full_name() ) ) )."\n\n".'Order #'.$order->get_ID().' ('.$date_string.')
			'."\n\n";
