...
<div class="wk_profileupdate woocommerce-MyAccount-content" style="width: 60%;">
	...
	<div class="wkmp_profile_preview_link">
		<h1> <?php echo esc_html__( 'Seller Profile', 'marketplace' ); ?> </h1>
		<a href="<?php echo esc_url( site_url() . '/' . $page_name . '/store/' . $user_meta_arr['shop_address'] ); ?>" class="button button-primary" target="_blank"><?php echo esc_html__( 'View Profile', 'marketplace' ); ?></a>
	</div>

<?php

if ( ! class_exists( 'MP_Form_Handler' ) ) {
...
if ( isset( $_POST['update_profile_submit'] ) ) {
	...
	$result = $wpmp_obj12->profile_edit_redirection();

	if ( isset( $result['success'] ) ) {
		echo '<div class="updated notice" style="margin-bottom: 10px;"><p>' . $result['success'] . '</p></div>';
	} elseif ( isset( $result['error'] ) ) {
		echo '<div class="error notice" style="margin-bottom: 10px;"><p>' . $result['error'] . '</p></div>';
	}
}
			...
			?>
				...
				<form action="" method="post" enctype="multipart/form-data">
					...
					<div class="wkmp-tab-content">
						...
						<div class="wkmp_profileinfo">
								...
								<div class="wkmp_profile_input">
									...
									<input type="text" placeholder="Shop Address 1" name="wk_store_add1" id="wk-store-add1" value="<?php echo isset( $user_meta_arr['billing_address_1'] ) ? esc_html( $user_meta_arr['billing_address_1'] ) : ''; ?>" class="wk_loginput"/>
						...
						<div class=" wkmp_profile_input">
							...
							<div class="banner-checkbox">
								<input type="checkbox" name="mp_display_banner" id="banner_visibility" value="yes" <?php if ( isset( $user_meta_arr['shop_banner_visibility'] ) && $user_meta_arr['shop_banner_visibility'] == 'yes' ) { echo 'checked'; } ?> />
								<label for="banner_visibility"><?php echo esc_html__( 'Show banner on seller page', 'marketplace' ); ?></label></div>
					...
					<div class="wkmp_profile_btn">
						<input type="submit" class='button button-primary' value="<?php echo esc_html__( 'Update', 'marketplace' ); ?>" name="update_profile_submit" id="update_profile_submit" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
