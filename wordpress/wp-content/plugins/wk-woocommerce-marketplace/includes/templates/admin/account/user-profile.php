	...
	<table class="form-table">
		...
		<tr>
			...
			<tr>
					...
					<td><input type="text" class="input-text form-control" name="shopurl" placeholder="<?php esc_html_e('eg- webkul', 'marketplace'); ?>" id="seller-shop" value="<?php echo get_user_meta( $user->ID, 'shop_address', true ); ?>" required="required" <?php echo esc_html( $disable ); ?>>
