...
<div class="wkmp-feedback-popup-container">
	<div class="wkmp_feedback_popup">
		<input type='hidden' value="<?php if (!empty($user_value)) {
    echo esc_html($user_value);
}
...
?>
		<div id='feedback_form'>
			...
			<form method="post" class="login">
				...
				<input type="text" class="input-text" name="wkmp_username" id="username" value="<?php if (!empty($_POST['username'])) {
